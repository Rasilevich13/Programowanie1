...
# Snake Case: user_login_count
 # '''
name_of_car = 'skoda'  # zmienna name_of_car jest typu string
# print(name_of_car) # 
...
### Wpisz w konsoli liczby, zwróć uwagę na różnice między zmienną numeryczną i łańcuchową 
 ...
 zm2 = int(input("Podaj zmienną y =") # wynik funkcji (argument wyjściowy funkcji) input ma typ string
 zm3_string = int(zm1) + int(zm2)  # konwersję zmiennej string na  float
 print(zm3_string)
...
# 1. Wykonaj odejmowanie, mnożenie i dzielenie 2 dowolnych liczb
 ...
 zm3 = float(zm1) + float(zm2) 

 x = input("Podaj zmienną x =") 
 y = input("Podaj zmienną y =")
wynik 




# 2. Oblicz wyrażenie 2x+5y   gdzie: x,y to dowolne dwie liczby które podaje użytkownik (w konso
...
print('Jestem',imię,nazwisko,'mam', wiek,kierunek)
