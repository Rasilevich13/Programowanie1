...
#lista_imiona = ['Nadia', 'Filip','Zofia',' Weronika', 'Paweł', 'Magda', 'Ola' ,'Ala','Filip']
#imie = input ('Podaj imie: ')
#id_imie = lista_imiona.index(imie)
#print('id:', id_imie)
#count_imie = lista_imiona.count(imie)
#print('id imienia {} to {}, imie {} występuje {} razy'.format(imie,id_imie,count_imie))
...
#print(dict_dane_osobowe['imie'][id])
#print(dict_dane_osobowe['nazwisko'][id])    
#print(dict_dane_osobowe['wiek'][id]) 
...
#dict_dane_osobowe['kierunek'] = kier
